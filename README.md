...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/renode-cores-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/renode-cores-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add renode-cores
# for installing globally
pixi global install renode-cores
```
...
It is possible to list all of the versions of `renode-cores` available on your platform:
...
```
pixi search renode-cores --channel conda-forge
```
